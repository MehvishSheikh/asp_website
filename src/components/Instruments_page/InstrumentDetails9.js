                ...
                <div className="col-lg-8">
                  ...
                  <div className="portfolio-description">
                    ...
                    <p>
                      ...
                      <br />
                      • Metering Technology-	Ultrasonic <br />
                      • Diameter-		DN25/40/50/65/100/150/200 <br />
                      • Flow range-		Q1 - 1 m3/hr, Q3 - 40 m3/hr <br />
                      • Turndown ratio- 	(R)Minimum 40 <br />
                      • Communication-	Inbuilt dual SIM based 4G with fall back on 2G <br />
                      • Power Source-	The meter and telemetry shall be operated using non-rechargeable batteries with minimum 3 years life assuming every 12 hours transmission. <br />
                      • Certification-		ISO 4064: 2014 <br />
                      • Ingress Protection-	Meter along with the telemetry system should be IP68 certified <br />
                      • Accuracy-		Class 2, T50, as per ISO 4064:2014 <br />
                      • Parameters to monitor-	The meter should transmit the following parameters to a secure cloud
                      1. Timestamp 2. Cumulative volume 3. Cumulative pump working hours <br />
                      • Transmission frequency-	Every 8/12/24 hours as per the requirement. <br />
                      • Transmission frequency-	Every 8/12/24 hours as per the requirement of the purchaser. <br />
                      •  Data Management Software-	The supplier shall acquire the data in the secured cloud and shall provide a web dashboard and mobile application to view and download data from the meters. <br />
                      • Integration with other dashboards- 	The supplier shall provide web APIs to integrate the flow meter data with any dashboard as desired by the purchaser. <br />
                      • Material of construction-	The body of the meter shall be brass/bronze/cast iron <br />
